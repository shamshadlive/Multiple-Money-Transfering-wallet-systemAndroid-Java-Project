...
public class ChildInTransactionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String childlogid = getIntent().getStringExtra("childretrive");


        Transactionsget(childlogid);
    ...
    public void showToast(String message) {
        ...
        Toast.makeText(ChildInTransactionActivity.this,
